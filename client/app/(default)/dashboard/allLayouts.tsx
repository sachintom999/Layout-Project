    ...
    <div className="col-span-full xl:col-span-6 bg-white dark:bg-slate-800 shadow-lg rounded-sm border border-slate-200 dark:border-slate-700">
      ...
      <div className="p-3">
          ...
          <table className="table-auto w-full dark:text-slate-300">
            ...
            <tbody className="text-sm divide-y divide-slate-100 dark:divide-slate-700">
              ...
              <tr>
                ...
                <td className="p-2 whitespace-nowrap">
                  <div className="font-medium text-slate-800 dark:text-slate-100 text-right">
                    -$1,299.22
                  </div>
                </td>
              </tr>
        ...
        <div className="text-center border-t border-slate-100 dark:border-slate-700 px-2">
          <a
            className="block text-sm font-medium text-indigo-500 hover:text-indigo-600 dark:hover:text-indigo-400 pt-4 pb-1"
            href="#0">
            View All -&gt;
          </a>
        </div>
